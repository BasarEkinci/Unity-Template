---
name: litmotion
description: "LitMotion zero-allocation tween library for Unity — LMotion.Create/BindTo, sequences, MotionHandle lifetime, Burst/DOTS-backed. Use instead of DOTween for high-performance tweening."
globs: ["**/LitMotion*", "**/*Motion*.cs", "**/*Tween*.cs"]
---
