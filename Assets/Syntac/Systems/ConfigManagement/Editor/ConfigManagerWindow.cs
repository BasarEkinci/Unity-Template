...
namespace Syntac.ConfigManagement.Editor
{
    /// <summary>
    ...
    public class ConfigManagerWindow : EditorWindow
    {
        ...
        // Known cost: this loads *every* ScriptableObject in the project to test the interface.
        // On large projects this is slow — it only runs on window open and on the Refresh button,
        // which is acceptable. Do not call it from OnGUI.
                        ...
                        if (isSelected)
                        {
                            buttonStyle = new(GUI.skin.button)
                            {
                                ...
                                normal =
                                {
                                    ...
                                    background = MakeTex(2, 2, new(0.24f, 0.48f, 0.90f, 1f))
                                }
                            };
                        }
                        else
