...
namespace Syntac.SettingsSystem.Audio
{
    ...
    /// </summary>
    /// <remarks>
    /// The AudioMixer asset must expose a parameter named exactly "AmbienceVolume". A missing parameter makes
    ...
    /// </remarks>
    public sealed class AmbienceVolumeSetting : SettingsBase<float>
    {
        private const string k_ExposedParam = "AmbienceVolume";
        private readonly AudioMixer m_Mixer;

        [Inject]
        public AmbienceVolumeSetting(AudioMixer mixer)
        {
            m_Mixer = mixer;
        }

        public override string Key => "ambience_volume";
